...
MainWidget::MainWidget(QWidget *parent) : QWidget(parent)
{
    ...
    penWidthLable = new QLabel(tr("画笔线宽: "));
    ...
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::VerPattern));
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::CrossPattern));
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::BDiagPattern));
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::FDiagPattern));
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::DiagCrossPattern));
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::LinearGradientPattern));
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::ConicalGradientPattern));
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::RadialGradientPattern));
    brushStyleComboBox->addItem(tr("SolidPattern"),static_cast<int>(Qt::TexturePattern));
    ...
    rightLayout->addWidget(penWidthLable,2,0);
...
void MainWidget::ShowPenWidth(int value)
{
    ...
    Qt::PenStyle style = Qt::PenStyle(penStyleComboBox->itemData(penStyleComboBox->currentIndex(),Qt::UserRole).toInt());
    Qt::PenCapStyle cap = Qt::PenCapStyle(penCapComboBox->itemData(penCapComboBox->currentIndex(),Qt::UserRole).toInt());
    Qt::PenJoinStyle join = Qt::PenJoinStyle(penStyleComboBox->itemData(penJoinComboBox->currentIndex(),Qt::UserRole).toInt());
...
void MainWidget::ShowPenJoin(int joinValue)
{
    ...
    Qt::PenStyle style = Qt::PenStyle(penStyleComboBox->itemData(penStyleComboBox->currentIndex(),Qt::UserRole).toInt());
    Qt::PenCapStyle cap = Qt::PenCapStyle(penCapComboBox->itemData(penCapComboBox->currentIndex(),Qt::UserRole).toInt());
    Qt::PenJoinStyle join = Qt::PenJoinStyle(penStyleComboBox->itemData(joinValue,Qt::UserRole).toInt());
